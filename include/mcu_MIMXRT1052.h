...
#define MCU_TMR_REGS TMR_BASE_PTRS
#define MCU_TMR_IRQS TMR_IRQS

#define MCU_PIO_PORTS 6
#define MCU_PIO_REGS GPIO_BASE_PTRS
//#define MCU_PIO_IRQS GPIO_IRQS doesn't work as expected IRQs aren't associated with port

#define MCU_UART_PORTS 9
#define MCU_UART_REGS LPUART_BASE_PTRS
#define MCU_UART_IRQS LPUART_RX_TX_IRQS
